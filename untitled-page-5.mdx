...
<Tabs>
  <Tab title="  iOS">
    ...
    <iframe src="https://drive.google.com/file/d/1RgPVgX9tVf25E2MN4CiJA842tR3csvgS/preview" width="640" height="360" />
    ...
    ![Overview Good Habit I OS](/images/Overview-GoodHabit-iOS.png "Overview Good Habit I OS")
    ...
    ![Weekly Rhythm Pattern I OS](/images/Weekly-Rhythm-Pattern-iOS.png "Weekly Rhythm Pattern I OS")
    ...
    **_e.g.,_** _If your date filter includes two Tuesdays—and you achieved a **50%** completion rate on the first Tuesday, but **0%** on the second—your overall Tuesday average shown on the chart will be **25%**)._
    ...
    ![Peak Focus Zone Pattern I OS](/images/Peak-Focus-Zone-Pattern-iOS.png "Peak Focus Zone Pattern I OS")
    ...
    **e.g.,** _If you have 3 habits scheduled for the Morning, and you complete 2/3 on day one and 1/3 on day two, your overall Morning completion rate will be **50%**._
    ...
    ![Missed Habits Pattern I OS](/images/Missed-Habits-Pattern-iOS.png "Missed Habits Pattern I OS")
    ...
    **_e.g.,_** _if you **have total 10 missed check-ins, 6 skips and 4 fails**, during the selected time range, the chart will display **60% Skipped** and **40% Failed**._
    ...
    ![Areas I OS](/images/Areas-iOS.png "Areas I OS")
    ...
    ![Goals Good Habit I OS](/images/Goals-GoodHabit-iOS.png "Goals Good Habit I OS")
    ...
    ![Habits Good Habit I OS](/images/Habits-GoodHabit-iOS.png "Habits Good Habit I OS")
    ...
    <iframe src="https://drive.google.com/file/d/1uPA4C2RByoFmdJ1NtOCmpX8GyPuFC1EB/preview" width="640" height="360" />
    ...
    ![Overview Bad Habit I OS](/images/Overview-BadHabit-iOS.png "Overview Bad Habit I OS")
    ...
    ![Patterns Bad Habit I OS](/images/Patterns-BadHabit-iOS.png "Patterns Bad Habit I OS")
    ...
    **Slip Rhythm** acts as a weekly vulnerability report. It uses horizontal red bars to tally up your slips for each day of the week, showing you exactly how many times you gave in on a Monday versus a Sunday over your chosen time range.
    ...
    ![Limit Habit Bad Habit I OS](/images/LimitHabit-BadHabit-iOS.png "Limit Habit Bad Habit I OS")
    ...
    ![Quit Habit Bad Habit I OS](/images/QuitHabit-BadHabit-iOS.png "Quit Habit Bad Habit I OS")
    ...
    2. **Days Clean & The Chain:** Prominently shows your total clean days (day with zero progress logs) for the period, alongside a visual progress chain. In the progress chain, your clean days remain clear, while any slip days instantly stand out as vertical red lines breaking the chain.
    ...
    ## Asking Habi about Your Progress

    From the Progress view, tap the chat icon in the bottom-right corner to open a conversation with Habi, your AI habit assistant.

    ![Progress View Habi I OS](/images/ProgressView-Habi-iOS.png "Progress View Habi I OS")

    Talk through your performance, ask Habi for insight into how you're actually doing, and get suggestions, whether that's improving an existing habit or figuring out where a new one might fit into your current routine.
  </Tab>
  <Tab title="🤖 Android">
    ## Progress: Good Habits

    <iframe src="https://drive.google.com/file/d/1QB0V4TFIw4V6YPEY-OfWhZBoesx_Flal/preview" width="640" height="360" />
    ...
    ![Overview Good Habit Android](/images/Overview-GoodHabit-Android.png "Overview Good Habit Android")
    ...
    ![Weekly Rhymth Patterns Android](/images/Weekly-Rhymth-Patterns-Android.png "Weekly Rhymth Patterns Android")
    ...
    ![Peak Focus Zone Patterns Android](/images/PeakFocusZone-Patterns-Android.png "Peak Focus Zone Patterns Android")

    Based on your custoTimes of Day (Morning, Afternoon, Evening), this chart averages your completion rates for each specific time block across the filtered period. 
    ...
    ![Missed Habits Patterns Android](/images/MissedHabits-Patterns-Android.png "Missed Habits Patterns Android")
    ...
    ![Areas Good Habit I OS](/images/Areas-GoodHabit-iOS.png "Areas Good Habit I OS")
    ...
    ![Goals Good Habit Android](/images/Goals-GoodHabit-Android.png "Goals Good Habit Android")
    ...
    ![Habits Good Habit Android](/images/Habits-GoodHabit-Android.png "Habits Good Habit Android")
    ...
    <iframe src="https://drive.google.com/file/d/1cO_Ui_U6vwvkGOuNLM62rYZqJyyF6B8H/preview" width="640" height="360" />
    ...
    ![Overview Bad Habit Android](/images/Overview-BadHabit-Android.png "Overview Bad Habit Android")
    ...
    ![Patterns Bad Habit Android](/images/Patterns-BadHabit-Android.png "Patterns Bad Habit Android")
    ...
    **Slip Rhythm** acts as a weekly vulnerability report. It uses horizontal red bars to tally up your slips for each day of the week, showing you exactly how many times you gave in on a Monday versus a Sunday over your chosen time range.
    ...
    ![Limit Habit Bad Habit Android](/images/LimitHabit-BadHabit-Android.png "Limit Habit Bad Habit Android")
    ...
    ![Quit Habit Bad Habit Android](/images/QuitHabit-BadHabit-Android.png "Quit Habit Bad Habit Android")
    ...
    ![Progress Habi Android](/images/Progress-Habi-Android.png "Progress Habi Android")
  ...
  <Tab title="🖥️ Website & Desktop">
    ...
    <iframe src="https://drive.google.com/file/d/1LSv9tAF5ML1U-KgfUEdQ-3-YzCD1lmyV/preview" width="640" height="360" />
    ...
    <iframe src="https://drive.google.com/file/d/1Djxe476TEsuRaRTqF7l2j1BTRxujkCoW/preview" width="640" height="360" />
